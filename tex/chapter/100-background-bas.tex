...
The first one being utilised the most and used for transferring commands, state, and values comes in 2 flavours. The standard data telegram is able to \alert{xxx} bytes per telegram....
