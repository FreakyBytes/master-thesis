...
\begin{figure}[H]
	...
	\caption[Detection Results of Unusual Network Traffic]{Detection Results of Unusual Network Traffic from 2017-01-12 02:00 to 09:00 with a minimal time resolution of 2 minutes. The modified time range is marked as a grey box.}
...
\begin{figure}[H]
	...
	\caption[Detection Results of a DoS]{Detection Results DoS attack from 2017-01-13 08:40 to 09:50 with a minimal time resolution of 2 minutes. The time range of the attack is marked as a grey box.}
	\label{fig:results:\figprefix}
...
\begin{figure}[H]
	...
	\caption[Detection Results of a Network Scan]{Detection Results of Network Scan from 2017-01-13 20:45 to 21:17 with a minimal time resolution of 30 seconds. The time range of the attack is marked as a grey box.}
	\label{fig:results:\figprefix}
