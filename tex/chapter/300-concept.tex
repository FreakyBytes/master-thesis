...
\begin{itemize}
	...
	\item \alert{Critical to describe the difference to original netflow concept/idea here and why this decision was made}
		...
		\subitem window length still needs to be synchronised among all agents to be able to use 
	\item after 
\end{itemize}
cf. \textcite{Bloedorn2001} for a basic "How to get started" IDS Data Mining Infrastructure
\todo{Describe how a (anal) window looks like: which information are contained, in which form etc.}
