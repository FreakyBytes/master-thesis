...
\todo{write about bad implications of this? Would could they are? Missing attacks, du to skipped windows? <- counter argument is, that attacks change the behaviour significantyl and noticeable, so a couple skipped window should not matter. }
