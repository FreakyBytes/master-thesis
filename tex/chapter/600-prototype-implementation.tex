...
For this it reads a tab separated log dump containing a timestamp and raw \gls{knx} telegrams, encoded in the \gls{baos} format.
...
Since the module used to capture... baos format... parser... etc...
